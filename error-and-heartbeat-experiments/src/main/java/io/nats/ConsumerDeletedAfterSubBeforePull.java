...
public class ConsumerDeletedAfterSubBeforePull {
    public static void main(String[] args) {
        ...
        try (Connection nc = Nats.connect(options)) {
            ...
            // Simulate someone else deleting the consumer before the pull.
            ...
            // Both Sync and Callback subscriptions get messages
            // sent to the error listener.
            // Sync subscription won't throw an error because it
            // never gets any statuses from the server.
            try {
